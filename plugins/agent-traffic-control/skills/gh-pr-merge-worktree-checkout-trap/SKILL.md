...
failed to run git: fatal: 'main' is already used by worktree at '/Users/huiyanwan/Documents/barryU_application_propensity/.claude/worktrees/compassionate-ishizaka-b7e3b7'
```
