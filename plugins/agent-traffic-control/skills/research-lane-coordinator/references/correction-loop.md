...
The unit of learning is an evidenced correction to a decision, not another instruction. Keep private incident records in the project's existing research/lesson store. Public skills contain generalized methods or clearly synthetic examples, not the identifying incident or its private trace.
