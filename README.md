...
| Plugin | Role |
|---|---|
| [**pr-conflict-site-regen**](plugins/pr-conflict-site-regen/) | *In-house example* — resolve rebase conflicts limited to a generated dashboard site (regenerate playbook + ID-collision rename + recurring-rebase loop). Pattern generalizes to any `generate_*.py` + generated-HTML setup. |
