...
| Skill | Role |
|---|---|
| [**pr-conflict-site-regen**](plugins/agent-squad-hr/skills/pr-conflict-site-regen/) | Generated-site rebase playbook (regenerate-from-source playbook + ID-collision rename + recurring-rebase loop). Pattern generalizes to any `generator.py` + generated-HTML setup. (Skill slug retains the historical `the project-` prefix from where it was extracted; methodology is now generic.) |
